# -*- encoding: utf-8 -*-
# stub: minitest-rails-capybara 3.0.0.rc1.20160507184752 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<minitest-rails>.freeze, ["~> 3.0.0.rc1"])
      ...
      s.add_dependency(%q<minitest-rails>.freeze, ["~> 3.0.0.rc1"])
